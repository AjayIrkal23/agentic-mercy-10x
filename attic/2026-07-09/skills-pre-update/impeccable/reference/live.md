...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live.mjs
```
...
```
LOOP:
  node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-poll.mjs   # default long timeout; no --timeout=
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-status.mjs
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-resume.mjs --id SESSION_ID
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-complete.mjs --id SESSION_ID
```
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-wrap.mjs --id EVENT_ID --count EVENT_COUNT --element-id "ELEMENT_ID" --classes "class1,class2" --tag "div" --text "TEXT_SNIPPET"
```
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID done --file RELATIVE_PATH
```
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-poll.mjs --reply EVENT_ID error "Short reason"
```
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/live-server.mjs stop
```
...
```bash
node /home/ajay-irkal/.claude/skills/impeccable/scripts/detect-csp.mjs
```
