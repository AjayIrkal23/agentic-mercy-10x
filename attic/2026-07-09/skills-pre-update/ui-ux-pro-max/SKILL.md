...
Get implementation-specific best practices for the stack this repo uses. Pass any
of the 16 supported stacks to `--stack` (`react`, `nextjs`, `vue`, `svelte`,
`angular`, `astro`, `flutter`, `swiftui`, `jetpack-compose`, `react-native`,
`html-tailwind`, `shadcn`, `nuxtjs`, `nuxt-ui`, `threejs`, `laravel`):
