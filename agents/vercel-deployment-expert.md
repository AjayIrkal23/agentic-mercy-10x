...
For specific CLI commands consult the Vercel CLI documentation, for compute configuration consult the Vercel Functions documentation, and for programmatic deployment management consult the Vercel API documentation.
